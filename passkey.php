...
class Am_Plugin_Passkey extends Am_Plugin
{
    ...
    public function __construct($param1, $param2)
    {
        ...
        // Track class instantiation to prevent issues
        ...
        try {
            ...
            $form->addSelect('resident_key', ['class' => 'am-el-wide'])
                ...
                ->loadOptions([
                    ...
                    'preferred' => 'Preferred - Prefer device storage but allow external (Recommended)',
            ...
            $form->addAdvCheckbox('require_resident_key')
                ...
                ->addRule('callback', 'Cannot require resident keys when preference is discouraged', function($val, $form) {
                    if ($val && $form->getValue('resident_key') === 'discouraged') {
                        return false;
                    }
                    return true;
                });
...
<body>
    ...
    private function getWebAuthnConfig()
    {
        ...
        return [
            ...
            'resident_key' => $config->get('misc.passkey.resident_key') ?: 'preferred',
